...
# True if that list is a palindrome (if it reads the same forwards as backwards) and False if not. 
# For example, the list ["alpha", "beta", "gamma", "delta", "gamma", "beta", "alpha"] 
